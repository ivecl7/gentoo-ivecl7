...
DESCRIPTION="gtx ebuild file"
# Homepage, not used by Portage directly but handy for developer reference
HOMEPAGE="https://github.com/ivecl7/gtx/"
# Point to any required sources; these will be automatically downloaded by
# Portage.
if [[ ${PV} == 9999 ]]; then
	EGIT_REPO_URI="https://github.com/ivecl7/gtx.git"
	inherit autotools git-r3
else
	SRC_URI="https://github.com/ivecl7/gtx/archive/refs/tags/${PV}.tar.gz"
fi
